...
1. `main` branch is reserved for stable, peer-reviewed documentation.
2. `feature/` branches are used for individual section drafting.
3. All changes are merged via **Pull Requests** after a technical audit.
...
- **Chu Ho Yan (22671017)** - DevOps & Security Engineer
- **Man Shuk Kwan (22657004)** - Quality Assurance Engineer
- **Lam Hiu Wing (32571005)** - UI/UX Frontend Developer

---

_This repository is for academic purposes only as part of the CS425 Portfolio._
